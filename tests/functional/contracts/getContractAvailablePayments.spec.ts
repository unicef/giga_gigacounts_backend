...
test.group('Contract Available Payments', (group) => {
  ...
  test('Successfully return all months to start o finish with the contract doesnt have payments', async ({
    ...
    expect(paymentDates[0].year).toBe(2022)
    expect(paymentDates[1].month).toBe(2)
    expect(paymentDates[1].year).toBe(2022)
    expect(paymentDates[2].month).toBe(3)
    expect(paymentDates[2].year).toBe(2022)
    expect(paymentDates[3].month).toBe(4)
    expect(paymentDates[3].year).toBe(2022)
    expect(paymentDates[4].month).toBe(5)
    expect(paymentDates[4].year).toBe(2022)
    expect(paymentDates[5].month).toBe(6)
    expect(paymentDates[5].year).toBe(2022)
    expect(paymentDates[6].month).toBe(7)
    expect(paymentDates[6].year).toBe(2022)
    expect(paymentDates[7].month).toBe(8)
    expect(paymentDates[7].year).toBe(2022)
  })
})
